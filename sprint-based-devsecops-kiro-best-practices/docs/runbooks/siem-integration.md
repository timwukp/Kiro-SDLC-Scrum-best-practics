...
- SAST/DAST scan results forwarded to SIEM for trend analysis
- Pipeline failure events correlated with security scan findings
- Container scan results tracked for vulnerability lifecycle metrics
- Security Champion receives daily digest of pipeline security events
...
| Sprint Security Metrics | Scrum Team | Per Sprint |
